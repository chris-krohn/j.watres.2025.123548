---
title: Microbial population shifts during disturbance induced foaming in anaerobic digestion of primary and activated sludge - Figures 1-6
output:
  html_document:
    df_print: paged
editor_options:
...
ggsave(plot = g3,  "./Figures/areaplot_top30_heatmapampviz.tiff", height=29, width=24, units='cm', dpi=300) #tiff
ggsave(plot = g3,  "./Figures/areaplot_top30_heatmapampviz.pdf", height=29, width=24, units='cm', dpi=300) #pdf
...
ggsave(plot = g1,  "./Figures/scatterpluslollie_pca.pdf", height=18, width=20, units='cm', dpi=300)
ggsave(plot = g1,  "./Figures/scatterpluslollie_pdf.tiff", height=18, width=20, units='cm', dpi=300)
