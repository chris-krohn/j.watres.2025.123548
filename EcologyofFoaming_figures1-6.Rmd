...
g3
ggsave(plot = g3,  "./Figures/areaplot_top30_heatmapampviz.png", height=29, width=24, units='cm', dpi=300)
```
...
pca1 <- pca_helper(psobject, color = "SludgeType", shape = "daysop", title =  NULL) +
  ...
  annotate(geom = 'text', label = expression("PERMANOVA 1: df=1, F=10.45, R"^2*"=0.32, "*italic(p)~"=0.001, n=12 per group"), x = -8, y = 8.5,
           hjust = 0, vjust = 0, size = 2.4) + 
  annotate(geom = 'text', label = expression("PERMANOVA 2: df=1, F=3.67, R"^2*"=0.27, "*italic(p)~"=0.009, n=6 per group"), x = -8, y = 7.5,      hjust = 0, vjust = 0, size = 2.4)
