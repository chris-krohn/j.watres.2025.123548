...
pexcl <- masterdata %>% 
 ...
 scale_color_manual("Sludge Type", values = cols) +
  ...
  annotate("text",x = as.Date("2023-06-03"), y = -0.4, label = "Foaming ", size = 2.5) +
   ...
   annotate("text",x = as.Date("2023-06-25"), y = -.4, label = "Steady state post foam", size = 2.5) +
...
ggsave("./Figures/Sup_lineplot_gasdaily_inclexclAD4.png", height=20, width=25, units='cm', dpi=300)
```
...
masterdata %>%
  ...
  annotate("text",x = as.Date("2023-04-24"), y = labely, label = "Steady state", size = 2.5) +
   annotate("segment", y = segmenty, yend = segmenty, x = as.Date("2023-04-17"), xend = as.Date("2023-05-02"),
            arrow = arrow(ends = "last", angle = 90, length = unit(.1,"cm"))) +
  ...
  annotate("text",x = as.Date("2023-06-03"), y = labely, label = "Foaming ", size = 2.5) +
   ...
   annotate("segment", y = segmenty, yend = segmenty, x = as.Date("2023-06-07"), xend = as.Date("2023-06-15"),
    ...
    annotate("text",x = as.Date("2023-06-24"), y = labely, label = "Steady state post foam", size = 2.5) +
   annotate("segment", y = segmenty, yend = segmenty, x = as.Date("2023-06-07"), xend = as.Date("2023-07-03"),
            arrow = arrow(ends = "first", angle = 90, length = unit(.1,"cm"))) +
...
ggsave(plot = g, "./Figures/Sup_violin_heatmap_filamen_hydrop.png", height=6, width=12, units='in', dpi=300)
