...
masterdata <- read.csv("masterdataProject1C_May24.csv")
...
taxa <-  data.frame(read.csv("020604-metabolimicstaxatable.csv")) %>% column_to_rownames("Sample.ID")
taxa <-  data.frame(t(taxa))
taxa <-  data.frame(t(taxa))

## ABUNDANCES OF METABOLITES FOR PS OBJECT
metabolome <- data.frame(read.csv("020524-metabolimicsresults_responseChris.csv")) 
...
## LOG ABUNDANCES OF METABOLITES FOR PS OBJECT
 metabolome <- data.frame(read.csv("020524-metabolimicsresults_LOGresponseChris.csv")) 
#LOG - FULL DATA
