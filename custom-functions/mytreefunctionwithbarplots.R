...
function(pf, ps.phylo,
         ...
         offset.text = 5,
         pwidth = 0.05) {
  metadatacolumn <- dplyr::enquo(metadatacolumn) # quote to enable object selection for function
  ...
  ps.phylo <- microbiome::transform(ps.phylo, transform = "compositional")
...
#               color = "lightgrey", offset = 0.04, size = 0.05,
#               pwidth = pwidth) +
